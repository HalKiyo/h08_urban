...
def explore_citymask(index):
    ...
    # pop data
    POP='gpw3' # change def summary() as well

    # city center modificatoin
    modify_flag = False
    ...
    # load data
    inf_path = h08dir + f'/dat/cty_lst_/{POP}/city_list03.txt'
    ...
    pop_path = f'{h08dir}/dat/pop_tot_/C05_a___20000000.gl5'
    ...
    # result path save
    resultpath = h08dir + f'/dat/cty_lst_/{POP}/result_citymask.txt'
