...
#######################################################
original_extension=".ct5"
converted_extension="=ct5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20240514/capetown/"
...
find "$H08DIR" -type f -name "*.ct5" -print0 | while IFS= read -r -d $'\0' file; do
