...
#######################################################
original_extension=".mx5"
converted_extension="=mx5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20241205/mexicocity/"
...
find "$H08DIR" -type f -name "*.mx5" -print0 | while IFS= read -r -d $'\0' file; do
