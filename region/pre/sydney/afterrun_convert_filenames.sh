...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20241205/sydney/"
...
find "$H08DIR" -type f -name "*.sy5" -print0 | while IFS= read -r -d $'\0' file; do
