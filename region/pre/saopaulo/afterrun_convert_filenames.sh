...
#######################################################
original_extension=".sp5"
converted_extension="=sp5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20241205/saopaulo/"
...
find "$H08DIR" -type f -name "*.sp5" -print0 | while IFS= read -r -d $'\0' file; do
