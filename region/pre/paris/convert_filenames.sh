...
#######################################################
original_extension=".pr5"
converted_extension="=pr5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20240514/paris/"
...
find "$H08DIR" -type f -name "*.pr5" -print0 | while IFS= read -r -d $'\0' file; do
