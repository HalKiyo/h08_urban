...
#######################################################
original_extension=".is5"
converted_extension="=is5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20241205/istanbul/"
...
find "$H08DIR" -type f -name "*.is5" -print0 | while IFS= read -r -d $'\0' file; do
