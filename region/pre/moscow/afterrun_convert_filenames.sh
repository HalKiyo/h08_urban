...
#######################################################
original_extension=".mc5"
converted_extension="=mc5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20241205/moscow/"
...
find "$H08DIR" -type f -name "*.mc5" -print0 | while IFS= read -r -d $'\0' file; do
