...
#######################################################
original_extension=".ls5"
converted_extension="=ls5"
#######################################################
...
###########################################################
SAVEDIR="/mnt/c/Users/tsimk/Downloads/research/H08/regional_model/fileshare/gdrive20240514/losangeles/"
...
find "$H08DIR" -type f -name "*.ls5" -print0 | while IFS= read -r -d $'\0' file; do
